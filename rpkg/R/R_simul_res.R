...
#' @param r0_6 reduction rate of control dose at Month 6
#' @param r1_6 reduction rate of low dose at Month 6
#' @param r2_6 reduction rate of medium dose at Month 6
#' @param r3_6 reduction rate of high dose at Month 6
#' @param r0_12 reduction rate of control dose at Month 6
#' @param r1_12 reduction rate of low dose at Month 6
#' @param r2_12 reduction rate of medium dose at Month 6
#' @param r3_12 reduction rate of high dose at Month 6
