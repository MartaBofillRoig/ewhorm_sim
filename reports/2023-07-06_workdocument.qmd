...
### Selection of efficacious doses and efficacy on selected doses
...
- Step 1: Evaluate dose-response relationship   by means of Cochran-Armitage trend test. 

- Step 2: Choose the most efficacious dose for further evaluation in stage 2.

- Step 3: Perform closed test for the selected dose using the stage 1 data.


### Safety and early stopping -- PENDING


### Sample size reassessment -- PENDING
