...
axis(1,c(1:3),c("low dose","medium dose","high dose"),cex.axis=1.3,cex=1.3)#,c("Selection","condPow","Pow"),padj=-0.3,cex.axis=1)
...
axis(1,c(1:3),c("lm","t-test","non par."),padj=-0.3,cex.axis=1)#,c("Selection","condPow","Pow"),padj=-0.3,cex.axis=1)
...
axis(1,c(1:4),c("lm","t-test","non par.diff","non par.val"),padj=-0.3,cex.axis=1)#,c("Selection","condPow","Pow"),padj=-0.3,cex.axis=1)
mtext(side=1,"Analysis",cex=1,line=2)#,line=2.2)
...
axis(1,c(1:4),c("0.1","0.2","0.3"),padj=-0.3,cex.axis=1)#,c("Selection","condPow","Pow"),padj=-0.3,cex.axis=1)
axis(1,c(1:4),c("lm","t-test","non par.diff","non par.val"),padj=-0.3,cex.axis=1)#,c("Selection","condPow","Pow"),padj=-0.3,cex.axis=1)
mtext(side=1,"Analysis",cex=1,line=2)#,line=2.2)
